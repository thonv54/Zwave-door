...
uint32_t SystemBusClock = DEFAULT_SYSTEM_CLOCK >> 1;
...
void SystemInit (void) {
  ...
  SIM->CLKDIV1 = (uint32_t)0x30000000UL; /* Update system prescalers */
  /* Switch to FEI Mode */
...
void SystemCoreClockUpdate (void) {
  ...
  SystemBusClock = SystemCoreClock / (1u + ((SIM->CLKDIV1 & SIM_CLKDIV1_OUTDIV4_MASK) >> SIM_CLKDIV1_OUTDIV4_SHIFT));
}
