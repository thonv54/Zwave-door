...
DWORD far EEOFFSET_COUNT_TXFALSE_far;

BYTE far EEOFFSET_DEVICES_SETUP_far[DEVICE_SETUP_SIZE];
...
BYTE far EEOFFSET_CENTRAL_SCENE_SLOW_REFRESH_far;

BYTE far EEOFFSET_SensorVal_far[SENSOR_VAL_SIZE];
